  ...
  return (
    <div className="min-h-screen p-6 ml-56">
      <div className="max-w-7xl mx-auto space-y-6">
        <div>
          <h1 className="text-4xl font-bold mb-2">Giriş / Çıkış Sistemi</h1>
          <p className="text-muted-foreground">Üye giriş-çıkış işlemlerini yönetin</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Şu An İçeride</CardTitle>
              <Users className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-primary">{currentCheckIns.length}</div>
            </CardContent>
          </Card>

          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Bugün Toplam</CardTitle>
              <TrendingUp className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-secondary">{todayCheckIns.length}</div>
            </CardContent>
          </Card>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <Label htmlFor="member">Üye Seçin *</Label>
              ...
              <Button onClick={handleCheckIn} className="w-full gradient-primary">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Şu An İçeridekiler ({currentCheckIns.length})
              </CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Bugünün Geçmişi ({todayCheckIns.length})</CardTitle>
          </CardHeader>
          <CardContent>
