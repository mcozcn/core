    ...
    return (
      <div className="p-4 md:p-6 md:pl-72 animate-fadeIn">
        <div className="flex items-center justify-center h-64">
          <div className="animate-spin w-6 h-6 md:w-8 md:h-8 border-4 border-primary border-t-transparent rounded-full"></div>
          <span className="ml-3 text-sm md:text-base">Performans verileri yükleniyor...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-4 md:p-6 md:pl-72 animate-fadeIn space-y-4 md:space-y-6">
      ...
      <div className="text-center space-y-2 md:space-y-4">
        <div>
          <h1 className="text-xl md:text-3xl font-serif">Personel Performans İzleme</h1>
          <p className="text-xs md:text-base text-muted-foreground mt-1">Personel performansını detaylı olarak takip edin ve analiz edin</p>
        </div>
      </div>
          ...
          <CardContent className="p-3 md:p-4">
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xs md:text-sm text-muted-foreground truncate">Başarı Oranı</p>
                <p className="text-lg md:text-2xl font-bold text-blue-600">{overallSuccessRate}%</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 border-green-200">
          <CardContent className="p-3 md:p-4">
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xs md:text-sm text-muted-foreground truncate">Toplam Gelir</p>
                <p className="text-lg md:text-2xl font-bold text-green-600">{formatCurrency(totalRevenue)}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 border-orange-200">
          <CardContent className="p-3 md:p-4">
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xs md:text-sm text-muted-foreground truncate">Toplam Randevu</p>
                <p className="text-lg md:text-2xl font-bold text-orange-600">{totalAppointments}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 border-purple-200">
          <CardContent className="p-3 md:p-4">
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xs md:text-sm text-muted-foreground truncate">Toplam Hakediş</p>
                <p className="text-lg md:text-2xl font-bold text-purple-600">{formatCurrency(totalCommission)}</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card>
        ...
        <CardContent className="p-4 md:p-6 pt-0">
          <Tabs defaultValue="cards" className="space-y-4 md:space-y-6">
            <TabsList className="grid grid-cols-2 w-full">
              <TabsTrigger value="cards" className="gap-1 md:gap-2 text-xs md:text-sm">
                <Users className="h-3 w-3 md:h-4 md:w-4" />
                <span className="hidden sm:inline">Personel Kartları</span>
                <span className="sm:hidden">Kartlar</span>
              </TabsTrigger>
              <TabsTrigger value="charts" className="gap-1 md:gap-2 text-xs md:text-sm">
            ...
            <TabsContent value="cards" className="space-y-4 md:space-y-6">
              {transformedStaffData.length === 0 ? (
                <div className="text-center py-8 md:py-12">
                  ...
                  <h3 className="text-base md:text-lg font-medium mb-2">Henüz personel verisi yok</h3>
                  <p className="text-sm text-muted-foreground">Personel performans verileri görüntülenecek.</p>
                </div>
              ) : (
            ...
            <TabsContent value="charts" className="space-y-4 md:space-y-6">
              {transformedStaffData.length === 0 ? (
                <div className="text-center py-8 md:py-12">
                  <BarChart3 className="mx-auto h-10 w-10 md:h-12 md:w-12 text-muted-foreground mb-3 md:mb-4" />
                  <h3 className="text-base md:text-lg font-medium mb-2">Henüz grafik verisi yok</h3>
                  <p className="text-sm text-muted-foreground">Personel performans grafikleri görüntülenecek.</p>
                </div>
              ) : (
