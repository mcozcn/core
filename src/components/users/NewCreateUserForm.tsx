...
interface NewCreateUserFormProps {
  onSuccess: () => void;
}
...
const availablePages = [
  ...
  { id: "personnel", label: "Personel", description: "Personel yönetimi", icon: "👤" },
];

const NewCreateUserForm = ({ onSuccess }: NewCreateUserFormProps) => {
  ...
  const togglePage = (pageId: string) => {
    if (pageId === "dashboard") {
      return; // Dashboard her zaman seçili
    }
